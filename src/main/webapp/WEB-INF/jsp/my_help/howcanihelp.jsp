...
<div id="about_podcasting_content" class="bg_color common_radius common_mar_pad shadowy">
    ...
    <ul style="padding-left:15px;">
        ...
        <li>  
            <a href="<c:url value="/contact?topic=error_indication"/>">flagging errors</a> you might encounter while surfing Podcastpedia.org
        </li>
        <li>  
        ...
        <li>  
			...
			<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-514d44491981966f"></script>
			<!-- AddThis Follow END -->
        </li>     
